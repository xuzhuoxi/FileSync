...
## <span id="a2">Getting Started(开始)</span>

### <span id="a2.1">1. Download(下载)</span>
...
### <span id="a2.3">3. Run(运行)<span>
仅支持命令行运行
命令行格式说明

#### <span id="a2.3.1">3.1 Command Line(命令行说明)<span>
支持两类命令行行为
1. 使用加载配置文件中的参数运行:
...
#### <span id="exclude">3.6. exclude<span>
格式：“file:\*.jpg,123.png;dir:folder1,fi\*er2,fi\*”，"file"部分与"dir"部分使用";"分隔
...
#### <span id="Lf">4.3. /Lf (log file)<span>
- 说明：开启记录日志，默认不记录日志
- 适用范围： [clear](#clear), [copy](#copy), [delete](#delete), [move](#move), [sync](#sync)

#### <span id="Lp">4.4. /Lp (print)<span>
- 说明：控制台打印信息，默认不打印信息
- 适用范围： [clear](#clear), [copy](#copy), [delete](#delete), [move](#move), [sync](#sync)

#### <span id="r">4.5. /r (recurse)<span>
- 说明：递归，默认不递归
- 适用范围： [clear](#clear), [copy](#copy), [delete](#delete), [move](#move), [sync](#sync)

#### <span id="s">4.6. /s (stable)<span>
- 说明：保持文件目录结构，默认不保持
...
## <span id="a4">Related Library(依赖)<span>
...
## <span id="a5">Contact(联系方式)<span>
xuzhuoxi 
<xuzhuoxi@gmail.com> or <mailxuzhuoxi@163.com>

## <span id="a6">License(开源许可证)<span>
